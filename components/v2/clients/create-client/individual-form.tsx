...
import { individualClientSchema, IndividualFormData } from "./validation-schema"
import { getOrgSlugFromUrl } from '@/utils/clientUtils'
import { toast } from 'sonner'


interface IndividualFormProps {
    onFormChange?: (data: IndividualFormData) => void;
}

export default function IndividualForm({ onFormChange }: IndividualFormProps) {
    ...
    useEffect(() => {
        const subscription = form.watch((value, { name, type }) => {
            if (onFormChange && type === 'change') {
                onFormChange(value as IndividualFormData)
            }
        })
